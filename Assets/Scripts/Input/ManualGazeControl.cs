    ...
    public class ManualGazeControl : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (MouseSupported)
            {
                ...
                rotate += mouseXYRotate / 4;
                translate += mouseXYTranslate / 4;
                translate += mouseXZTranslate / 4;
            }
            ...
            if (KeyboardSupported)
            {
                ...
                rotate += keyboardXYRotate / 4;
                rotate += keyboardXZRotate / 4;
                translate += keyboardXYTranslate / 4;
                translate += keyboardXZTranslate / 4;
            }
